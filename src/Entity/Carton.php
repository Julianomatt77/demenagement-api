...
class Carton
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['carton:read', 'user:read'])]
    private ?int $id = null;

    #[ORM\Column]
    #[Groups(['carton:read', 'carton:write', 'user:read', 'room:read'])]
    private ?int $numero = null;

    #[ORM\Column(nullable: true)]
    #[Groups(['carton:read', 'carton:write', 'room:read'])]
    ...
    #[Groups(['carton:read', 'carton:write'])]
    private ?Room $room = null;

    #[ORM\Column(nullable: true)]
    #[Groups(['carton:read', 'room:read'])]
